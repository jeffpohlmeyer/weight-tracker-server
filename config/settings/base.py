...
# weight_points_server/
APPS_DIR = ROOT_DIR / "weight_points_server"
env = environ.Env()
...
# MIGRATION_MODULES = {"sites": "weight_points_server.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "weight_points_server.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Jeffrey Pohlmeyer""", "jeffvp@pm.me")]
...
DJOSER = {
    ...
    "TOKEN_MODEL": None,
    "PASSWORD_RESET_CONFIRM_URL": "auth/forgot/{uid}/{token}",
...
# REST_FRAMEWORK['PAGE_SIZE'] = 9999
# REST_FRAMEWORK['MAX_PAGE_SIZE'] = 9999
# REST_FRAMEWORK['PAGE_SIZE_QUERY_PARAM'] = 'pageSize'
